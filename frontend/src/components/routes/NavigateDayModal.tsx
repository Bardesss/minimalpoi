...
export default function NavigateDayModal({ dayLabel, waypoints, onClose }: {
  ...
  return (
    <ModalShell
      onClose={onClose}
      backdropProps={{ "data-testid": "navmodal-backdrop" }}
      cardStyle={{ background: theme.color.surface0, borderRadius: theme.radius.modal, boxShadow: theme.shadow.modal, padding: 20, width: 320, maxWidth: "92vw" }}
    >
