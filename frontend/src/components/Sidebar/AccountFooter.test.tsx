...
describe("AccountFooter", () => {
  it("shows the username + role and logs out", async () => {
    ...
    render(<AccountFooter username="admin" role="admin" onLogout={onLogout} onOpenSettings={() => {}} />);
...
describe("AccountFooter settings button", () => {
  it("calls onOpenSettings when the gear is clicked", async () => {
    ...
    render(<AccountFooter username="admin" role="admin" onLogout={() => {}} onOpenSettings={onOpenSettings} />);
